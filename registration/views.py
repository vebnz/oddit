...
def activate(request, activation_key,
    ...
    **Template:**
    ...
    popular_categories_list = Job.objects.values('category',
                                                 'category__name').annotate(num_jobs=Count("id")).distinct()
    ...
    return render_to_response(template_name,
                              { 'account': account,
                               ...
                               'popular_categories':
                               popular_categories_list,'popular_tags': popular_tags,
...
def register(request, success_url=None,
    ...
    **Template:**
    ...
    return render_to_response(template_name,
                              { 'form': form, 'popular_categories':
                               popular_categories_list, 'popular_tags':
                               popular_tags, 'categories': category_list},
                              context_instance=context)
